...
Cat::Cat(std::string breed) : AAnimal("Cat"),  _breed(breed), _sound("meow Meow") {
	print_line("Cat constructor called!");
	this->_brain = new Brain();
}

Cat::Cat() : AAnimal("Cat"), _breed("Not specified"), _sound("meow Meow"){
	print_line("Cat constructor called!");
	this->_brain = new Brain();
}

Cat::Cat(const Cat &ref) : AAnimal(ref), _breed(ref._breed), _sound(ref._sound), _brain(new Brain(*ref._brain)) {
